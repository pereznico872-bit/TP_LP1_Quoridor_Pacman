/*******************************************************************************************
 * Quoridor Pac-Man - LP1 2026
 * Implementacion educativa en C99 + raylib
 *
 * Compilar en Linux/macOS:
 *   gcc quoridor_pacman.c -o quoridor_pacman -lraylib -lm
 *
 * En Windows con raylib instalado normalmente se usa el comando que trae raylib:
 *   gcc quoridor_pacman.c -o quoridor_pacman.exe -lraylib -lopengl32 -lgdi32 -lwinmm
 *
 * Controles principales:
 *   CONFIGURACION: flechas, ENTER, TAB, E
 *   JUEGO: flechas mueve Pac-Man, mouse coloca muro temporal, ENTER termina turno, R reinicia
 *   PVP: en turno de fantasma usar WASD para mover el fantasma actual
 *   EDITOR: teclas P,1,2,3,4,B,M para elegir herramienta; click para colocar; S guardar
 *******************************************************************************************/
...
int main(void)
{
    ...
    /* Imagen personalizada del menu.
       Debe estar en la misma carpeta que el .c o dentro de una carpeta imagenes. */
